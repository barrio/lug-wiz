...
BLOG_AUTHOR = "Marco Heins"  # (translatable)
BLOG_TITLE = "Linux User Group Witzenhausen"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://barrios.github.io/lug-wiz/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://barrios.github.io/lug-wiz/"
BLOG_EMAIL = "marco.heins@posteo.de"
BLOG_DESCRIPTION = "This is our blog."  # (translatable)
